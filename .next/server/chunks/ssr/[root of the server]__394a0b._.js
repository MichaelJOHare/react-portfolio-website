...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$projects$2f$chess$2f$utils$2f$square$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/app/projects/chess/utils/square.ts [app-ssr] (ecmascript)");
;
const kingMovementStrategy = (board, piece)=>{
    const legalMoves = [];
    let row = piece.currentSquare.row;
    let col = piece.currentSquare.col;
    const directions = [
...
;
;
const pawnMovementStrategy = (board, piece, moveHistory)=>{
    const legalMoves = [];
    const { row, col } = piece.currentSquare;
    const direction = piece.color === __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$projects$2f$chess$2f$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PlayerColor"].WHITE ? -1 : 1;
    const backRank = piece.color === __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$projects$2f$chess$2f$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PlayerColor"].WHITE ? 0 : 7;
    const startingRow = piece.color === __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$projects$2f$chess$2f$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PlayerColor"].WHITE ? 6 : 1;
    ...
    const addEnPassantMoves = (row, col, piece, board, moveHistory, legalMoves)=>{
        ...
        const enPassantStartingRow = piece.color === __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$projects$2f$chess$2f$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PlayerColor"].WHITE ? 1 : 6;
        const enPassantEndRow = piece.color === __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$projects$2f$chess$2f$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PlayerColor"].WHITE ? 3 : 4;
        const direction = piece.color === __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$projects$2f$chess$2f$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PlayerColor"].WHITE ? -1 : 1;
    ...
    const addPromotionMoves = (row, col, piece, board, legalMoves)=>{
        const direction = piece.color === __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$projects$2f$chess$2f$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PlayerColor"].WHITE ? -1 : 1;
        const rowBeforePromotionRow = piece.color === __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$projects$2f$chess$2f$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PlayerColor"].WHITE ? 1 : 6;
        const forwardSquare = {
            row: row + direction,
            col
        };
...
const useChessGame = ()=>{
    ...
    const initializeBoard = ()=>{
        const setup = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$projects$2f$chess$2f$utils$2f$board$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setupPieces"];
        ...
        [
            ...
            const rowOffset = color === __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$projects$2f$chess$2f$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PlayerColor"].WHITE ? 7 : 0;
            const pawnRow = color === __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$projects$2f$chess$2f$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PlayerColor"].WHITE ? 6 : 1;
            setup.forEach(({ type, positions, movementStrategy })=>{
                positions.forEach(({ row, col })=>{
                    ...
                    const piece = createPiece(player, type, color, square, movementStrategy, true, hasMoved);
...
;
;
const ChessPiece = ({ piece, type, color, square, isBoardFlipped })=>{
    const pieceColor = isBoardFlipped ? color === __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$projects$2f$chess$2f$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PlayerColor"].WHITE ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$projects$2f$chess$2f$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PlayerColor"].BLACK : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$projects$2f$chess$2f$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PlayerColor"].WHITE : color;
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__394a0b._.js.map