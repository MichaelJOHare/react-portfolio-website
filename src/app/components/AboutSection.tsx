          ...
          <div className="grid grid-cols-1 items-center gap-12 md:grid-cols-2 lg:gap-16">
            <div>
              ...
              <p className="mt-6 text-lg leading-relaxed text-gray-700 dark:text-gray-300">
                Welcome to my website&mdash;it&apos;s still a work in progress,
                so new things will keep being added. I&apos;m Michael or Mike,
                whichever you prefer. I love spending time outdoors doing things
                like backpacking, skiing, and fishing. Having lived in Colorado
          ...
          <div className="grid grid-cols-1 items-center gap-12 md:grid-cols-2 lg:gap-16">
            <div className="md:order-last">
              ...
              <p className="mt-6 text-lg leading-relaxed text-gray-700 dark:text-gray-300">
                ...
                right corner), I really like chess. Plus it&apos;s very fun to
                build a chess app from scratch&mdash;there&apos;s always
                something to improve. Whether it&apos;s adding the Stockfish
                chess engine or implementing a way to import FEN strings to the
                board, you&apos;ll always have something to work on.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="mt-6 space-y-4 text-lg leading-relaxed text-gray-700 dark:text-gray-300">
                <p>
                  ...
                  (one of the oldest operating systems!) so I haven&apos;t had a
                  lot of time to focus on side projects. But I&apos;ve been
                  doing some learning in my free time with new web frameworks.
                  It&apos;s an exciting time to be working in tech!
                </p>
                <p>
